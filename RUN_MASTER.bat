...
echo ============================================================
echo   Chay 3 script nen:
echo   1. run_srt.py   - Voice to SRT
echo   2. run_thumb.py - Tao thumbnail
echo   3. run_edit.py  - Merge video MP4
echo ============================================================
echo.
...
REM Chay run_thumb.py nen
echo [MASTER] Starting run_thumb.py in background...
start /min cmd /c "python run_thumb.py & pause"
...
echo   - run_thumb.py: Dang chay nen (minimized)
echo   - run_edit.py:  Dang chay nen (minimized)
echo ============================================================
echo.
echo Nhan phim bat ky de dong cua so nay (3 script van chay nen)
pause
