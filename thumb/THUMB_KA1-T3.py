...
# Run: python THUMB_KA1-T3.py <code>
    ...
    "elements": [
        {
            ...
            "h": 1080,
            "color": "#1a1a2e",
            "image_path": "assets/THUMB_KA1-T3_bg.jpg"
        },
        {
            "id": 2,
            "type": "photo",
        ...
        },
        {
            ...
            "w": 1286,
            "h": 836,
            "sample_text": "MY PARENTS CALLED EVERY JOB I APPLIED TO AND TOLD THEM I HAD A CRIMINAL RECORD, TRYING TO RUIN MY FUTURE BEFORE IT EVEN BEGAN—UNTIL ONE HR MANAGER FINALLY ASKED FOR PROOF.",
            "sample_highlights": " TRYING TO RUIN MY FUTURE BEFORE IT EVEN BEGAN—UNTIL",
            "font": "UTM-AvoBold",
            "color": "#000000",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_KA1-T3.py <code>")
        sys.exit(1)
