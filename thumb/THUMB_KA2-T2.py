...
# -*- coding: utf-8 -*-
# THUMB_KA2-T2.py
# Generated by VE3 Thumb Designer - 2026-03-06 10:42
# Edit DESIGN config to customize layout and colors.
# Run: python THUMB_KA2-T2.py <code>
    ...
    "elements": [
        {
            ...
            "h": 1080,
            "color": "#0a1a3a",
            "image_path": "assets/THUMB_KA2-T2_bg.jpg"
        },
        {
            "id": 2,
            "type": "photo",
        ...
        },
        {
            ...
            "w": 1185,
            "h": 773,
            "sample_text": "TIÊU ĐỀ MẪU CHO KÊNH KA2 THUMBNAIL THIẾT KẾ ĐẸP",
            "sample_highlights": "KA2",
            "font": "UTM-AvoBold",
            "color": "#ffffff",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_KA2-T2.py <code>")
        sys.exit(1)
