...
# Bảng màu đồng bộ
TEXT_COLOR        = RGBA("#ffffff")       # chữ trắng
TEXT_SHADOW_COLOR = RGBA("#ffffff", 120)  # bóng chữ đen mờ
BADGE_COLOR       = RGBA("#00bf63")       # khung đen
BADGE_SHADOW_COLOR= RGBA("#ffffff")       # bóng vàng 
