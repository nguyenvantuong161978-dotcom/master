...
# -*- coding: utf-8 -*-
# THUMB_KA3-T1.py
# Generated by VE3 Thumb Designer - 2026-03-05 15:29
# Edit DESIGN config to customize layout and colors.
# Run: python THUMB_KA3-T1.py <code>
...
DESIGN = {
    ...
    "elements": [
        ...
        },
        {
            ...
            "w": 1368,
            "h": 850,
            "sample_text": "TIÊU ĐỀ MẪU CHO KÊNH KA3 THUMBNAIL THIẾT KẾ ĐẸP",
            "sample_highlights": "KA3",
            "font": "UTM-AvoBold",
            "color": "#000000",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_KA3-T1.py <code>")
        sys.exit(1)
