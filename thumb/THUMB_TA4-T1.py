...
# -*- coding: utf-8 -*-
# THUMB_TA4-T1.py
# Generated by VE3 Thumb Designer - 2026-03-10 11:16
# Edit DESIGN config to customize layout and colors.
# Run: python THUMB_TA4-T1.py <code>
...
DESIGN = {
    ...
    "elements": [
        ...
        },
        {
            ...
            "w": 1278,
            "h": 422,
            "sample_text": "THE WILL HE  JUST BURNED, THE WILL HE  JUST BURNED",
            "font": "Anton",
            "font_size": 0,
            "color": "#fff500",
            "bg_color": "#dd3a1e",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_TA4-T1.py <code>")
        sys.exit(1)
