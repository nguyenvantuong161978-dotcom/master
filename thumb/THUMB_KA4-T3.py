...
# -*- coding: utf-8 -*-
# THUMB_KA4-T3.py
# Generated by VE3 Thumb Designer - 2026-03-06 10:54
# Edit DESIGN config to customize layout and colors.
# Run: python THUMB_KA4-T3.py <code>
...
DESIGN = {
    ...
    "elements": [
        ...
        },
        {
            ...
            "w": 1286,
            "h": 836,
            "sample_text": "TIÊU ĐỀ MẪU CHO KÊNH KA4 THUMBNAIL THIẾT KẾ ĐẸP",
            "sample_highlights": "KA4",
            "font": "UTM-AvoBold",
            "color": "#ffffff",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_KA4-T3.py <code>")
        sys.exit(1)
