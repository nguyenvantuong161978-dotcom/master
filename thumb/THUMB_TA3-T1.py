...
# -*- coding: utf-8 -*-
# THUMB_TA3-T1.py
# Generated by VE3 Thumb Designer - 2026-03-08 16:11
# Edit DESIGN config to customize layout and colors.
# Run: python THUMB_TA3-T1.py <code>
    ...
    "elements": [
        {
            ...
            "h": 1080,
            "color": "#1a1a2e",
            "image_path": "assets/THUMB_TA3-T1_bg.png"
        },
        {
            "id": 2,
            "type": "photo",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_TA3-T1.py <code>")
        sys.exit(1)
