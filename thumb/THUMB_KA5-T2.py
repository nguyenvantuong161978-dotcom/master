...
# -*- coding: utf-8 -*-
# THUMB_KA5-T2.py
# Generated by VE3 Thumb Designer - 2026-03-05 15:41
# Edit DESIGN config to customize layout and colors.
# Run: python THUMB_KA5-T2.py <code>
    ...
    "elements": [
        {
            ...
            "h": 1080,
            "color": "#111111",
            "image_path": "assets/THUMB_KA5-T2_bg.jpeg"
        },
        {
            "id": 2,
            "type": "photo",
        ...
        },
        {
            ...
            "w": 1222,
            "h": 780,
            "sample_text": "TIÊU ĐỀ MẪU CHO KÊNH KA5 THUMBNAIL THIẾT KẾ ĐẸP",
            "sample_highlights": "KA5",
...
def main():
    ...
    if not code:
        print("Usage: python THUMB_KA5-T2.py <code>")
        sys.exit(1)
