...
# Bảng màu đồng bộ
TEXT_COLOR        = RGBA("#fefefe")       # chữ trắng
TEXT_SHADOW_COLOR = RGBA("#fefefe", 120)  # bóng chữ đen mờ
BADGE_COLOR       = RGBA("#4b96b6")       # khung đen
BADGE_SHADOW_COLOR= RGBA("#fefefe")       # bóng vàng
