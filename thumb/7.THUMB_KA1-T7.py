...
layout = {
    ...
    "bar_padding": 10,         # khoảng cách chữ hook tới viền pill
    "top_padding": 10,          # khoảng cách text tới lề trên
    ...
    "keyword_max_font": 100,   # cỡ chữ lớn nhất cho hook
    ...
    "text_color": "#ffffff",          # màu chữ thường (trắng)
    "highlight_color": "#ffd600",     # màu highlight trong text (vàng sáng)
    "keyword_color": "#ffd600",       # màu chữ hook (đỏ tươi)
    "keyword_stroke": 10,              # độ dày viền chữ hook
    "keyword_stroke_color": "#000000",# màu viền chữ hook (hồng nhạt)
    ...
    "hook_text_color": "#ffd600",         # màu chữ hook (đỏ tươi)
...
def generate(row):
    ...
    # --- Nền full (phủ trước) ---
    text_bg_img_path = ASSETS_DIR / "KA1-T7.jpg"
    try:
...
def load_df():
    ...
    df = df[df["channel"].str.contains("KA1-T7", na=False)]
